...
resolving them. Two currently stand that way: **Equitable Baseline Scoring** and
the **Average Ceiling Metric**. The sources state the containment relation
between them in both directions, so I left it open instead of picking one. I
would rather that was settled by you than by me.
